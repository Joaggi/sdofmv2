            ...
            if int(match.group(1)[4:6]) >= start_month:
                ...
                if start_month and end_month:
                    ...
                    if (
                        ...
                        matching_files.append(str(os.path.join(dirpath, f)))
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate a CSV index of netCDF files.")
    parser.add_argument(
        "--dirpath",
        default="/home/jinsu/surya-bench",
        type=str,
        help="Root Directory path to search for netCDF files. Do NOT include year and month",
    )
    parser.add_argument("--start_year", type=int, default=2019, help="Start year of data")
    parser.add_argument("--start_month", type=int, default=1, help="starting month  of data")
    parser.add_argument("--end_year", default=2019, type=int, help="Ending year of data")
